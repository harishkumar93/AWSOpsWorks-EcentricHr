...
<script src="<?php bloginfo('stylesheet_directory'); ?>/js/responsive-accordion.min.js"></script>
...
<div class="main-header-child">
  <div class="social-sharing-icons">
     <ul>
        <li style="padding-top: 3px; color: #505050 !important;">Follow Us :</li>
        <a href="#"><li><img src="<?php bloginfo('stylesheet_directory'); ?>/images/facebook.png" alt="" /></li></a>
        <a href="#"><li><img src="<?php bloginfo('stylesheet_directory'); ?>/images/twitter.png" alt="" /></li></a>
        <a href="#"><li><img src="<?php bloginfo('stylesheet_directory'); ?>/images/in.png" alt="" /></li></a>
     </ul>
</div>
